...
export default function HeroSection() {
  return (
    <section className="relative flex h-auto items-center justify-center overflow-hidden">
            ...
            <CarouselItem key={index} className="relative">
              ...
              <div className="absolute inset-0 flex h-full w-full items-center justify-center">
                <div className="px-4 text-center text-white sm:px-6 lg:px-8">
                  <h1 className="mb-4 text-4xl font-bold max-sm:text-lg sm:text-5xl md:text-6xl">
                    Discover Your Next Adventure
                  </h1>
                  <p className="mx-auto mb-8 w-full text-xl max-sm:max-w-[200px] max-sm:text-xs sm:text-2xl md:text-3xl">
                    Explore the world with us and create unforgettable memories
                  </p>
                  <Button
                    size="lg"
                    className="rounded-full bg-primary px-6 py-3 text-lg font-bold text-white hover:bg-primary/90 max-sm:p-5 max-sm:text-sm"
                  >
                    Explore Our Tours
                  </Button>
                </div>
